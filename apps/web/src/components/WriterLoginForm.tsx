...
/**
 * The form itself posts to the exact same signInWithEmail() every
 * other identity type uses (curator-actions.ts) — one auth system,
 * not a separate writer-specific login action. The original build had
 * its own loginWriter() calling into WriterAuth's SHA256+static-salt
