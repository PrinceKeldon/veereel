...
import { loginProducer } from "@/lib/producer-auth";
    ...
    <div className="flex min-h-screen items-center justify-center bg-[var(--bg)] px-6">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-[var(--text-muted)]">Sign in to discover and book story pitches</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-[var(--text-muted)]">
          New to Veereel?{" "}
          <Link href="/kilig/platform/claim" className="text-[var(--accent-marigold)] hover:underline">
            Create profile
          </Link>
        </p>
      </div>
